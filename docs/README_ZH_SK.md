...
> **🎉 NEW: Mobile App Now Available!** Check out [README_MOBILE_SK.md](./README_MOBILE_SK.md) for the complete React Native + Expo mobile app that shares the same Supabase backend!
> https://youtube.com/shorts/qcASa0Ywsy4?feature=share

## 🇸🇰 Slovak Documentation Available

[Slovak Documentation](./README_SK.md) | [Mobile Slovak Documentation](./README_MOBILE_SK.md)

This repository includes full documentation in Slovak:
- **README_SK.md** - Complete Slovak translation of the main documentation
- **README_MOBILE_SK.md** - Complete Slovak translation of the mobile app documentation
